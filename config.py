...
# تأمین‌کنندگان پشتیبان تبدیل صوت به متن (JSON) — وقتی اعتبار AvalAI تمام شود
# به‌طور خودکار به این‌ها fallback می‌شود؛ نمونه: STT_FALLBACK_SETUP_FA.txt
...
_PERSISTENT_SEED_KEYS = (
    ...
    'AVALAI_TTS_MAX_BYTES', 'AVALAI_TTS_MAX_CHARS', 'STT_FALLBACK_PROVIDERS',
    # ارز دیجیتال
